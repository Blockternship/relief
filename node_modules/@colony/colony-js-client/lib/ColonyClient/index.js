...
var _CreateTask = require('./senders/CreateTask');
...
var ColonyClient = function (_ContractClient) {
  ...
  (0, _createClass3.default)(ColonyClient, [{
    ...
    value: function initializeContractMethods() {
      ...
      makeTaskCaller('getTaskPayout', [['role', 'role'], ['token', 'tokenAddress']], [['amount', 'bigNumber']]);
      ...
      makeTaskCaller('getTaskWorkRatingSecret', [['role', 'role']], [['secret', 'hexString']]);
      ...
      this.addCaller('getRewardPayoutInfo', {
        ...
        output: [['reputationRootHash', 'string'], ['totalTokens', 'bigNumber'], ['totalTokenAmountForRewardPayout', 'bigNumber'], ['remainingTokenAmount', 'bigNumber'], ['token', 'tokenAddress'], ['blockNumber', 'number']]
      });
      ...
      this.addEvent('TaskDueDateChanged', [['id', 'number'], ['dueDate', 'date']]);
      ...
      this.addEvent('TaskWorkerPayoutChanged', [['id', 'number'], ['token', 'tokenAddress'], ['amount', 'number']]);
      this.addEvent('TaskDeliverableSubmitted', [['id', 'number'], ['deliverableHash', 'ipfsHash']]);
      this.addEvent('TaskWorkRatingRevealed', [['id', 'number'],
      // $FlowFixMe
      ['role', 'role'], ['rating', 'number']]);
      ...
      this.addSender('claimPayout', {
        input: [['taskId', 'number'], ['role', 'role'], ['token', 'tokenAddress']]
      });
      this.createTask = new _CreateTask2.default({
        client: this,
        name: 'createTask',
        functionName: 'makeTask',
        input: [['specificationHash', 'ipfsHash'], ['domainId', 'number']],
        defaultValues: {
          domainId: _constants.DEFAULT_DOMAIN_ID
        },
        eventHandlers: {
          TaskAdded: {
            contract: this.contract,
      ...
      this.addSender('moveFundsBetweenPots', {
        input: [['fromPot', 'number'], ['toPot', 'number'], ['amount', 'bigNumber'], ['token', 'tokenAddress']]
      });
      ...
      this.addSender('setTaskManagerPayout', {
        input: [['taskId', 'number'], ['token', 'tokenAddress'], ['amount', 'bigNumber']]
      });
      ...
      var makeExecuteTaskChange = function makeExecuteTaskChange(name, input) {
        ...
        return _this2.addMultisigSender(name, {
          ...
          getRequiredSignees: function () {
            var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(_ref15) {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 2:
                      ...
                      return _context4.abrupt('return', taskRoles.map(function (_ref17) {
      ...
      makeExecuteTaskChange('setTaskWorkerPayout', [['token', 'tokenAddress'], ['amount', 'bigNumber']], [_constants.MANAGER_ROLE, _constants.WORKER_ROLE]);
      makeExecuteTaskChange('setTaskEvaluatorPayout', [['token', 'tokenAddress'], ['amount', 'bigNumber']], [_constants.MANAGER_ROLE, _constants.EVALUATOR_ROLE]);
    }
  }]);
  return ColonyClient;
